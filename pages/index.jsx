          ...
          <div className={`${styles.twoColGrid} width-container fade-in`}>
            <div className={styles.heroLeft}>
              ...
              <h1 className={styles.heroH1}>
                 Stop fighting your tech. I’ll come to you and make it work—guaranteed.
              </h1>
          ...
          <div className="width-container">
            ...
            <div className={styles.bentoGrid}>
                ...
                <div className={styles.serviceCard}>
                  ...
                  <button className={styles.btnOutline} onClick={() => setIsModalOpen(true)}>Learn More</button>
                </div>
                ...
                <div className={`${styles.serviceCard} ${styles.serviceCardPrimary}`}>
                  ...
                  <button className={styles.btnSecondary} onClick={() => setIsModalOpen(true)}>Request Recovery</button>
                </div>
